      ...
      <div className="space-y-3">
        ...
        {selectedPlan ? <section className={panel}>
          ...
          <div className="border-t border-zinc-200 dark:border-white/10">
            ...
            {destinationType === 'hub' ? <p className="px-3 py-2 text-xs text-zinc-500">{overview?.next_hubs?.length ? 'Saving this mapping enables an outgoing linehaul connection to the selected hub. No Admin approval is required.' : 'No other active Logistics hubs are available. Refresh after another Logistics account becomes active.'}</p> : null}
