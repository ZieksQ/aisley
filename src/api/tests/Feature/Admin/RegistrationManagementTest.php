...
class RegistrationManagementTest extends TestCase
{
    ...
    public function test_database_seeder_grants_registration_permissions_to_initial_admin(): void
    {
        ...
        $this->assertEqualsCanonicalizing(
            ['registrations.view', 'registrations.review', 'audit-logs.view', 'platform-settings.view', 'platform-settings.manage', 'notifications.view', 'users.view', 'users.manage', 'seller_compliance.manage', 'finance.view', 'finance.manage', 'support-tickets.view', 'support-tickets.manage', 'notification-campaigns.view', 'notification-campaigns.manage'],
