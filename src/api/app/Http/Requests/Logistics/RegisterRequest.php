...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'middle_name' => ['nullable', 'string', 'max:1'], 'contact_number' => ['required', 'string', 'max:32'],
            'sex' => ['required', new Enum(UserSex::class)], 'birth_date' => ['required', 'date', 'before:today'],
            'business_name' => ['required', 'string', 'max:255'],
            'address.address_line_1' => ['required', 'string', 'max:255'], 'address.address_line_2' => ['nullable', 'string', 'max:255'],
            ...
            'role' => ['prohibited'], 'status' => ['prohibited'], 'reviewer_id' => ['prohibited'],
            'organization_id' => ['prohibited'], 'hub_id' => ['prohibited'], 'subscription' => ['prohibited'],
        ];
    }

    private function evidenceRules(): array
    {
        return ['required', File::image()->types(['jpg', 'jpeg', 'png', 'webp'])->max(10 * 1024), 'extensions:jpg,jpeg,png,webp',
