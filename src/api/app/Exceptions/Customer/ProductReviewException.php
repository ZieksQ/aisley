...
class ProductReviewException extends RuntimeException
{
    ...
    {
        return new self('PRODUCT_REVIEW_NOT_FOUND', $message, 404);
    }

    public static function forbidden(string $message = 'You are not allowed to change this Product review.'): self
    {
        return new self('PRODUCT_REVIEW_FORBIDDEN', $message, 403);
    }
