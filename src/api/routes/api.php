...
use App\Http\Controllers\Courier\FailedDeliveryAttemptController;
...
use App\Http\Controllers\Logistics\LinehaulReceivingController;
...
Route::prefix('v1/logistics')->name('logistics.')->middleware(['auth:sanctum', 'logistics.active', 'policy.consent'])->group(function () {
    ...
    Route::get('/linehaul/trips/{trip}/receiving', [LinehaulReceivingController::class, 'show'])->whereUuid('trip');
    Route::post('/linehaul/trips/{trip}/receiving/start', [LinehaulReceivingController::class, 'start'])->whereUuid('trip');
    Route::post('/linehaul/trips/{trip}/receiving/batches', [LinehaulReceivingController::class, 'batch'])->whereUuid('trip');
    Route::post('/linehaul/trips/{trip}/receiving/finish', [LinehaulReceivingController::class, 'finish'])->whereUuid('trip');
    Route::post('/linehaul/trips/{trip}/receiving/discrepancies/{discrepancy}/resolve', [LinehaulReceivingController::class, 'resolve'])->whereUuid('trip')->whereUuid('discrepancy');
    ...
    Route::post('/sorting/sessions', [SortingController::class, 'openSession'])->name('sorting.sessions.store');
    Route::post('/sorting/sessions/{session}/close', [SortingController::class, 'closeSession'])->whereUuid('session')->name('sorting.sessions.close');
    Route::post('/sorting/sessions/{session}/batches', [SortingController::class, 'batch'])->whereUuid('session')->name('sorting.sessions.batches.store');
    Route::get('/dispatch/couriers', [DispatchScheduleController::class, 'couriers'])->name('dispatch.couriers.index');
    Route::get('/dispatch/schedules', [DispatchScheduleController::class, 'index'])->name('dispatch.schedules.index');
    Route::post('/dispatch/schedules', [DispatchScheduleController::class, 'store'])->name('dispatch.schedules.store');
...
Route::prefix('v1/courier')->name('courier.')->middleware(['auth:sanctum', 'courier.active', 'policy.consent'])->group(function () {
    ...
    Route::get('/final-mile-batches', [FinalMileBatchController::class, 'index'])->name('final-mile-batches.index');
    Route::get('/final-mile-batches/{schedule}', [FinalMileBatchController::class, 'show'])->whereUuid('schedule')->name('final-mile-batches.show');
    Route::post('/final-mile-batches/{schedule}/accept', [FinalMileBatchController::class, 'accept'])->whereUuid('schedule')->name('final-mile-batches.accept');
    Route::get('/final-mile-batches/{schedule}/route', [FinalMileBatchController::class, 'route'])->whereUuid('schedule')->name('final-mile-batches.route');
    ...
    Route::get('/delivery-proofs/{proof}/photo', [ProofOfDeliveryController::class, 'photo'])->whereUuid('proof')->name('delivery-proofs.photo');
    Route::post('/final-mile-tasks/{task}/failed-attempts', [FailedDeliveryAttemptController::class, 'store'])->whereUuid('task')->name('final-mile-tasks.failed-attempts.store');
