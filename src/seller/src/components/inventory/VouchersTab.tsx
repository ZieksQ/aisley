      ...
      >
        <form onSubmit={handleCreateVoucher} className="space-y-4 text-xs">
          ...
          <div className="pt-4 flex items-center justify-end gap-2 border-t border-slate-200 dark:border-slate-800">
            ...
            <button
              type="submit"
              className="px-5 py-2 rounded-xl bg-[#E723A2] hover:bg-[#D61590] text-white text-xs font-bold uppercase tracking-wider transition shadow-sm flex items-center gap-1.5 cursor-pointer"
            >
              <FaCheck /> Create Voucher
            </button>
          </div>
        </form>
      </Modal>
