      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">
            Atelier Catalog & Stock Inventory
          </h1>
          <p className="text-xs text-slate-500">
            Curate luxury product listings, monitor variant quantities, and manage discount promotions.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200">
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1.5 ${
                activeTab === 'vouchers' ? 'bg-white text-slate-900 shadow-xs' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              <FaTicket className="text-[#E723A2]" /> Vouchers & Promos
            </button>
          </div>
          ...
          {activeTab === 'catalog' && (
            <button
              ...
              className="px-4 py-2 rounded-xl bg-[#E723A2] hover:bg-[#D61590] text-white text-xs font-bold uppercase tracking-wider transition shadow-sm flex items-center gap-2 cursor-pointer"
            >
              <FaPlus /> Add Product
            </button>
          )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center">
              ...
              <div className="sm:col-span-3">
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 bg-[#F8FAFC] text-xs font-medium focus:ring-2 focus:ring-[#E723A2] focus:bg-white focus:outline-none"
                >
                  <option value="all">All Atelier Categories</option>
                              ...
                              {product.status === 'active' && (
                                <div className="flex items-center gap-1">
                                  <button
                                    ...
                                    className="size-5 rounded bg-slate-100 text-slate-600 hover:bg-slate-200 grid place-items-center font-bold"
                                  ...
                                  <button
                                    ...
                                    className="px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 hover:bg-slate-200 text-[10px] font-bold"
                                    title="Add 5 units"
                                  >
                                    +5
                                  </button>
                          ...
                          <td className="py-3.5 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                ...
                                className="p-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition"
                                title="Edit Product"
                              >
                              ...
                              <button
                                ...
                                className="p-2 rounded-lg border border-slate-200 text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition"
