              ...
              >
                ...
                <span
                  className={`px-2 py-0.5 rounded-full text-[10px] font-mono-num font-bold ${
                    statusFilter === tab.id ? 'bg-[#E723A2] text-white' : 'bg-slate-100 text-slate-600'
                  }`}
                >
                  {tab.count}
                </span>
                  ...
                  {filteredOrders.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="py-12 text-center text-slate-400">
                        ...
                        <p className="font-bold text-sm text-slate-600">No orders found</p>
                        <p className="text-xs text-slate-400 mt-0.5">Try adjusting your status filter or search term</p>
                      </td>
                    </tr>
                  ) : (
                      ...
                      <tr key={order.id} className="hover:bg-slate-50/80 transition">
                        <td className="py-3.5 px-4">
                          <button
                            ...
                            className="font-bold text-slate-900 hover:text-[#E723A2] font-mono-num block"
                          >
                            {order.id}
                          </button>
                        ...
                        <td className="py-3.5 px-4">
                          ...
                          <p className="text-[10px] text-slate-400 font-mono-num">{order.customer.phone}</p>
                        </td>
                        ...
                        <td className="py-3.5 px-4 max-w-[220px]">
                          <div className="flex items-center gap-2">
                            <img
                              ...
                              className="size-9 rounded-lg object-cover border border-slate-200 shrink-0"
                            />
                            <div className="truncate">
                              <p className="font-bold text-slate-800 truncate">{order.items[0]?.productTitle}</p>
                              <p className="text-[11px] text-slate-500">
                        ...
                        <td className="py-3.5 px-4">
                          <p className="font-bold text-emerald-700 font-mono-num text-sm">
                        ...
                        <td className="py-3.5 px-4 space-y-1">
                          ...
                          {order.trackingNumber && (
                            <p className="text-[10px] font-mono-num text-slate-500 block truncate">
                              {order.trackingNumber}
                            </p>
                          )}
                        </td>
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            {order.status === 'delivered' && (
                              <span className="text-[11px] font-bold text-emerald-600">Disbursed</span>
                            )}
                          </div>
                        </td>
                      </tr>
