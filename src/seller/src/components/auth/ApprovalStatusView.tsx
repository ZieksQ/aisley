  ...
  return (
    <div className="w-full max-w-3xl mx-auto my-6">
      <div className="rounded-3xl bg-white p-6 sm:p-8 text-slate-900 shadow-2xl border border-slate-100 relative">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-black text-slate-900 tracking-tight">
                  {isApproved ? 'Atelier Storefront Activated' : 'Application Under Compliance Review'}
                </h2>
                <span
        ...
        <div className="my-6 p-4 rounded-2xl bg-slate-900 text-white flex flex-wrap items-center justify-between gap-4 border border-slate-800">
          ...
          <div className="flex items-center gap-2">
            {!isApproved ? (
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-amber-400 text-xs font-bold uppercase tracking-wider transition border border-slate-700 cursor-pointer"
              >
                  ...
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5">
                      {isCompleted ? (
                        ...
                        <FaCircle className="size-3 text-slate-300 mx-0.5 mt-0.5" />
                      )}
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        <p
                          className={`text-sm font-bold ${
                            isCompleted ? 'text-emerald-950' : isInProgress ? 'text-amber-950' : 'text-slate-600'
                          }`}
                        >
        ...
        <div className="rounded-2xl bg-[#F8FAFC] border border-slate-200 p-5 space-y-3">
          <h4 className="text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center gap-2">
            <FaBuilding className="text-[#E723A2]" /> Submitted Atelier Profile
          </h4>
