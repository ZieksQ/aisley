...
type Variant = { key: string; id?: string; option_value_indexes: number[]; labels: string[]; sku: string; opening_stock: string; price: string; original_price: string; status: 'active' | 'inactive'; image_upload_id?: string; image_preview?: string; inventory_sku_id?: string | null; on_hand?: number; reserved?: number; available?: number }
...
export function ProductFormPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    const matrix = variants.map(({ id, sku, opening_stock, price, original_price, status, option_value_indexes, image_upload_id }) => ({
