---
title: Seller Shop Categories
system: AISLEY
type: seller's shop categories and product catagories
version: 1.0
status: Draft
role: Seller
...
- The header shows the Shop categories and bullet below each header shows the product categories
...
## 9. Automotive & Motorcycle - Group 9
...
## 14. Office and School Supplies - Group 12
...
## JSON Format (For Direct Parsing)
