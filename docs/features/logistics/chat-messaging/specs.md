...
| `/api/v1/courier/operational-conversations` | Same list/start/detail/history/send/read actions | Implemented for Logistics contact on an active offered/accepted task; Seller/Buyer channels deferred |
