...
- Same-email Customer, Seller, Admin, or Logistics records never inherit Courier access.
...
- Vehicle and OR/CR edits follow the registry's planned routes, revision/idempotency, private delivery, and independent replacement rules; never route them through profile/photo endpoints. Initial registration approval remains Logistics-owned; later vehicle edits do not reset it. License/payout changes remain separate.
